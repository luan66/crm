$(function () {
    ...
    temporary_datagrid.datagrid({
        ...
        fitColumns: true,
        striped: true,
        url: "/policy/temporaryList.do?state=3",
        pagination: true,
        singleSelect: true,
        ...
        columns: [[
            ...
            {
                field: 'remark', title: '查看批改信息', width: 100, align: 'center', formatter: function (value, row, index) {
                return "<a href='#' id='detail' onclick='showAdvice();'>查看批改意见</a><input id='remark' type='hidden' value='"+value+"'>";
            }
            // {
...
function showAdvice() {
    var hha = $("#temporary_datagrid").datagrid("getSelected");
    $.messager.alert("批改意见", hha.remark, "info");
}
