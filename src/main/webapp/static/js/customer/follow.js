$(function () {
    ...
    var methodObj = {
        ...
        save: function () {
            plan_form.form("submit", {
                url: "/plan/saveOrUpdate.do?status=true",
                success: function (data) {
                    var data = $.parseJSON(data);
                    if (data.success) {
                        $.messager.alert("温馨提示", data.message, "info", function () {
    ...
    plan_datagrid.datagrid({
        ...
        columns: [[
            ...
            {field:'date',title:'跟进时间',width:50},
            ...
            {field:'subject',title:'跟进主题',width:50,},
